...
;
	($.$mol_icon_android) = class $mol_icon_android extends ($.$mol_icon) {
		path(){
			return "M16.61 15.15C16.15 15.15 15.77 14.78 15.77 14.32S16.15 13.5 16.61 13.5H16.61C17.07 13.5 17.45 13.86 17.45 14.32C17.45 14.78 17.07 15.15 16.61 15.15M7.41 15.15C6.95 15.15 6.57 14.78 6.57 14.32C6.57 13.86 6.95 13.5 7.41 13.5H7.41C7.87 13.5 8.24 13.86 8.24 14.32C8.24 14.78 7.87 15.15 7.41 15.15M16.91 10.14L18.58 7.26C18.67 7.09 18.61 6.88 18.45 6.79C18.28 6.69 18.07 6.75 18 6.92L16.29 9.83C14.95 9.22 13.5 8.9 12 8.91C10.47 8.91 9 9.24 7.73 9.82L6.04 6.91C5.95 6.74 5.74 6.68 5.57 6.78C5.4 6.87 5.35 7.08 5.44 7.25L7.1 10.13C4.25 11.69 2.29 14.58 2 18H22C21.72 14.59 19.77 11.7 16.91 10.14H16.91Z";
		}
	};
...
;
	($.$mol_icon_apple) = class $mol_icon_apple extends ($.$mol_icon) {
		path(){
...
;
	($.$bog_music_landing) = class $bog_music_landing extends ($.$mol_view) {
		Skin(){
		...
		Hero_subtitle(){
			const obj = new this.$.$mol_view();
			(obj.dom_name) = () => ("p");
			(obj.sub) = () => (["Своя музыка на всех устройствах. Бесплатно, без рекламы, играет офлайн."]);
			return obj;
		}
		Open_icon(){
		...
		Extension_label(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => (["Расширение для Chrome"]);
			return obj;
		}
		Extension(){
			const obj = new this.$.$mol_link();
			(obj.uri) = () => ("https://github.com/b-on-g/music/releases/latest");
			(obj.sub) = () => ([(this.Extension_icon()), (this.Extension_label())]);
			return obj;
		}
		Hero_actions(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.Open()), (this.Extension())]);
			return obj;
		}
		Hero(){
			const obj = new this.$.$mol_view();
		...
		Feature_vk(){
			const obj = new this.$.$bog_music_landing_feature();
			(obj.Icon) = () => ((this.Feature_vk_icon()));
			(obj.title) = () => ("Сохраняет из VK");
			(obj.text) = () => ("Одна кнопка прямо в списке аудио на vk.com — трек уезжает в твою фонотеку.");
			return obj;
		}
		Feature_tube_icon(){
		...
		Feature_tube(){
			const obj = new this.$.$bog_music_landing_feature();
			(obj.Icon) = () => ((this.Feature_tube_icon()));
			(obj.title) = () => ("Ищет на YouTube");
			(obj.text) = () => ("Поиск, прослушивание превью и скачивание звука одной кнопкой.");
			return obj;
		}
		Feature_tg_icon(){
		...
		Feature_tg(){
			const obj = new this.$.$bog_music_landing_feature();
			(obj.Icon) = () => ((this.Feature_tg_icon()));
			(obj.title) = () => ("Принимает из Телеграма");
			(obj.text) = () => ("Перешли песню боту — она появится в «Моей музыке» на всех устройствах.");
			return obj;
		}
		...
		Feature_offline(){
			...
			(obj.title) = () => ("Играет офлайн");
			(obj.text) = () => ("Треки лежат на устройстве. Метро, самолёт, дача — музыка есть.");
			return obj;
		}
		Feature_sync_icon(){
		...
		Feature_sync(){
			const obj = new this.$.$bog_music_landing_feature();
			(obj.Icon) = () => ((this.Feature_sync_icon()));
			(obj.title) = () => ("Синхронизирует между устройствами");
			(obj.text) = () => ("Телефон и компьютер видят одну фонотеку. Перенос аккаунта — одной ссылкой.");
			return obj;
		}
		Feature_loud_icon(){
		...
		Feature_loud(){
			const obj = new this.$.$bog_music_landing_feature();
			(obj.Icon) = () => ((this.Feature_loud_icon()));
			(obj.title) = () => ("Выравнивает громкость");
			(obj.text) = () => ("Тихие и громкие записи звучат одинаково. Эквалайзер и обрез трека — в комплекте.");
			return obj;
		}
		Feature_share_icon(){
		...
		Feature_share(){
			...
			(obj.title) = () => ("Делится ссылкой");
			(obj.text) = () => ("Трек шифруется, ключ живёт только в ссылке. Получатель откроет — и заиграет.");
			return obj;
		}
		Feature_font_icon(){
		...
		Feature_font(){
			const obj = new this.$.$bog_music_landing_feature();
			(obj.Icon) = () => ((this.Feature_font_icon()));
			(obj.title) = () => ("Крупный шрифт");
			(obj.text) = () => ("Три размера текста в настройках — удобно читать без очков.");
			return obj;
		}
		Features_list(){
			const obj = new this.$.$mol_view();
		...
		Install_title(){
			const obj = new this.$.$mol_view();
			(obj.dom_name) = () => ("h2");
			(obj.sub) = () => (["Как поставить на телефон"]);
			return obj;
		}
		Install_text(){
			const obj = new this.$.$mol_view();
			(obj.dom_name) = () => ("p");
			(obj.sub) = () => (["Магазин приложений не нужен: открой ссылку в браузере и добавь ярлык на экран."]);
			return obj;
		}
		Install_android_icon(){
			const obj = new this.$.$mol_icon_android();
			return obj;
		}
		Install_android(){
			const obj = new this.$.$bog_music_landing_feature();
			(obj.Icon) = () => ((this.Install_android_icon()));
			(obj.title) = () => ("Android, Chrome");
			(obj.text) = () => ("Меню ⋮ → «Установить приложение» или «Добавить на главный экран».");
			return obj;
		}
		Install_ios_icon(){
			const obj = new this.$.$mol_icon_apple();
			return obj;
		}
		Install_ios(){
			const obj = new this.$.$bog_music_landing_feature();
			(obj.Icon) = () => ((this.Install_ios_icon()));
			(obj.title) = () => ("iPhone, Safari");
			(obj.text) = () => ("Кнопка «Поделиться» → «На экран Домой».");
			return obj;
		}
		Install_list(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.Install_android()), (this.Install_ios())]);
			return obj;
		}
		Install_open_label(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => (["Открыть Bog Music"]);
			return obj;
		}
		Install_open(){
			const obj = new this.$.$mol_link();
			(obj.uri) = () => ((this.app_uri()));
			(obj.sub) = () => ([(this.Install_open_label())]);
			return obj;
		}
		Install(){
			const obj = new this.$.$mol_view();
		...
		Source(){
			const obj = new this.$.$mol_link();
			(obj.uri) = () => ("https://github.com/b-on-g/music");
			(obj.sub) = () => (["Открытый код на GitHub"]);
			return obj;
		}
		Baza(){
			const obj = new this.$.$mol_link();
			(obj.uri) = () => ("https://github.com/giper-dev/baza");
			(obj.sub) = () => (["Синхронизация — Giper Baza"]);
			return obj;
		}
		Foot(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.Source()), (this.Baza())]);
			return obj;
		}
		plugins(){
			return [(this.Skin())];
		...
		app_uri(){
			return "https://b-on-g.github.io/music/";
		}
		sub(){
			return [
				(this.Hero()), 
	...
	($mol_mem(($.$bog_music_landing.prototype), "Skin"));
	($mol_mem(($.$bog_music_landing.prototype), "Hero_image"));
	($mol_mem(($.$bog_music_landing.prototype), "Hero_title"));
	($mol_mem(($.$bog_music_landing.prototype), "Hero_subtitle"));
	($mol_mem(($.$bog_music_landing.prototype), "Open_icon"));
	($mol_mem(($.$bog_music_landing.prototype), "Open_label"));
	($mol_mem(($.$bog_music_landing.prototype), "Open"));
	($mol_mem(($.$bog_music_landing.prototype), "Extension_icon"));
	($mol_mem(($.$bog_music_landing.prototype), "Extension_label"));
	($mol_mem(($.$bog_music_landing.prototype), "Extension"));
	($mol_mem(($.$bog_music_landing.prototype), "Hero_actions"));
	($mol_mem(($.$bog_music_landing.prototype), "Hero"));
	($mol_mem(($.$bog_music_landing.prototype), "Features_title"));
	($mol_mem(($.$bog_music_landing.prototype), "Feature_vk_icon"));
	($mol_mem(($.$bog_music_landing.prototype), "Feature_vk"));
	($mol_mem(($.$bog_music_landing.prototype), "Feature_tube_icon"));
	($mol_mem(($.$bog_music_landing.prototype), "Feature_tube"));
	($mol_mem(($.$bog_music_landing.prototype), "Feature_tg_icon"));
	($mol_mem(($.$bog_music_landing.prototype), "Feature_tg"));
	($mol_mem(($.$bog_music_landing.prototype), "Feature_offline_icon"));
	($mol_mem(($.$bog_music_landing.prototype), "Feature_offline"));
	($mol_mem(($.$bog_music_landing.prototype), "Feature_sync_icon"));
	($mol_mem(($.$bog_music_landing.prototype), "Feature_sync"));
	($mol_mem(($.$bog_music_landing.prototype), "Feature_loud_icon"));
	($mol_mem(($.$bog_music_landing.prototype), "Feature_loud"));
	($mol_mem(($.$bog_music_landing.prototype), "Feature_share_icon"));
	($mol_mem(($.$bog_music_landing.prototype), "Feature_share"));
	($mol_mem(($.$bog_music_landing.prototype), "Feature_font_icon"));
	($mol_mem(($.$bog_music_landing.prototype), "Feature_font"));
	($mol_mem(($.$bog_music_landing.prototype), "Features_list"));
	($mol_mem(($.$bog_music_landing.prototype), "Features"));
	($mol_mem(($.$bog_music_landing.prototype), "Install_title"));
	($mol_mem(($.$bog_music_landing.prototype), "Install_text"));
	($mol_mem(($.$bog_music_landing.prototype), "Install_android_icon"));
	($mol_mem(($.$bog_music_landing.prototype), "Install_android"));
	($mol_mem(($.$bog_music_landing.prototype), "Install_ios_icon"));
	($mol_mem(($.$bog_music_landing.prototype), "Install_ios"));
	($mol_mem(($.$bog_music_landing.prototype), "Install_list"));
	($mol_mem(($.$bog_music_landing.prototype), "Install_open_label"));
	($mol_mem(($.$bog_music_landing.prototype), "Install_open"));
	($mol_mem(($.$bog_music_landing.prototype), "Install"));
	($mol_mem(($.$bog_music_landing.prototype), "Source"));
	($mol_mem(($.$bog_music_landing.prototype), "Baza"));
	($mol_mem(($.$bog_music_landing.prototype), "Foot"));
	($.$bog_music_landing_feature) = class $bog_music_landing_feature extends ($.$mol_view) {
		Title(){
			const obj = new this.$.$mol_view();
			(obj.dom_name) = () => ("h3");
			(obj.sub) = () => ([(this.title())]);
		...
		sub(){
			return [(this.Icon()), (this.Body())];
		}
	};
	($mol_mem(($.$bog_music_landing_feature.prototype), "Title"));
	($mol_mem(($.$bog_music_landing_feature.prototype), "Text"));
	($mol_mem(($.$bog_music_landing_feature.prototype), "Body"));
	($mol_mem(($.$bog_music_landing_feature.prototype), "Icon"));
...
var $;
(function ($) {
    $mol_style_attach("bog/music/landing/landing.view.css", "/* Та же палитра, что у приложения (app/app.view.css), чтобы лендинг и плеер\n   выглядели одним продуктом. */\n[bog_music_landing][bog_builderui_base][bog_builderui_lights=\"light\"] {\n\t--bog_builderui_control: hsl( 210, 68%, 42% );\n\t--bog_builderui_focus: hsl( 210, 72%, 36% );\n\t--bog_builderui_current: hsl( 26, 82%, 44% );\n\t--bog_builderui_special: hsl( 26, 82%, 44% );\n\t--bog_builderui_back: #faf9f7;\n\t--bog_builderui_card: #ffffff;\n}\n[bog_music_landing][bog_builderui_base][bog_builderui_lights=\"dark\"],\n[bog_music_landing][bog_builderui_base][bog_builderui_lights=\"system\"] {\n\t--bog_builderui_control: hsl( 210, 72%, 64% );\n\t--bog_builderui_focus: hsl( 210, 76%, 72% );\n\t--bog_builderui_current: hsl( 30, 85%, 60% );\n\t--bog_builderui_special: hsl( 30, 85%, 60% );\n\t--bog_builderui_text: #d4d4d8;\n\t--bog_builderui_back: #18181b;\n\t--bog_builderui_card: #09090b;\n}\n@media ( prefers-color-scheme: light ) {\n\t[bog_music_landing][bog_builderui_base][bog_builderui_lights=\"system\"] {\n\t\t--bog_builderui_control: hsl( 210, 68%, 42% );\n\t\t--bog_builderui_focus: hsl( 210, 72%, 36% );\n\t\t--bog_builderui_current: hsl( 26, 82%, 44% );\n\t\t--bog_builderui_special: hsl( 26, 82%, 44% );\n\t\t--bog_builderui_text: #09090b;\n\t\t--bog_builderui_back: #faf9f7;\n\t\t--bog_builderui_card: #ffffff;\n\t}\n}\nhtml:has([bog_music_landing]) {\n\tbackground: var(--bog_builderui_back);\n}\n\n/* Страница длиннее экрана: корню mol достаётся height:100%, поэтому фон\n   красим на html, а корень отпускаем в высоту по содержимому. */\nhtml:has([bog_music_landing]),\nbody:has([bog_music_landing]) {\n\tbackground: #faf9f7;\n}\n@media ( prefers-color-scheme: dark ) {\n\thtml:has([bog_music_landing]),\n\tbody:has([bog_music_landing]) {\n\t\tbackground: #18181b;\n\t}\n}\n[bog_music_landing][mol_view_root] {\n\theight: auto;\n\tmin-height: 100%;\n}\n");
})($ || ($ = {}));
